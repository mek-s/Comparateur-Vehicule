...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 13 jan. 2024 à 12:23
...
CREATE TABLE IF NOT EXISTS `avis` (
  ...
  `status` enum('ettente','valide','refuse') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
INSERT INTO `avis` (`avis_id`, `user_id`, `vehicule_id`, `marque_id`, `status`, `commentaire`, `supp`) VALUES
(1, 1, 5, NULL, 'refuse', 'c', 0);
...
INSERT INTO `caracteristiques` (`carac_id`, `carac_nom`, `unite_mesure`, `categ_id`, `image_id`) VALUES
(1, 'Type Moteur', '', 1, 20),
(2, 'Consommation', 'kpl', 1, 22),
(3, 'Transmission', '', 1, 21),
(4, 'Type Essance', '', 1, 19),
(5, 'Prix', 'dzd', 3, 18);
...
CREATE TABLE IF NOT EXISTS `categories` (
  ...
  `categ_nom` varchar(40) DEFAULT NULL,
...
INSERT INTO `categories` (`categ_id`, `categ_nom`) VALUES
(1, 'Motor'),
(2, 'Dimensions'),
(3, 'Autre');
...
INSERT INTO `contacts` (`contact_id`, `contact_nom`, `value`, `supp`, `image_id`) VALUES
(1, 'facebook', 'http://www.facebook.com/fordfrance', 0, 6),
(2, 'email', 'https://www.gmail.com', 0, 7),
(3, 'instagram', 'https://www.instagram.com/fordfrance/', 0, 8),
(4, 'myCpntact', 'myValue', 0, 31);
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  PRIMARY KEY (`news_id`),
  KEY `image_id` (`image1`,`image2`,`image3`,`image4`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `news` (`news_id`, `title`, `description`, `subtitle`, `supp`, `date_publication`, `image1`, `image2`, `image3`, `image4`) VALUES
(1, 'Hyundai Alcazar receives minor price hike in January 2024', 'Hyundai India has updated the prices of its three-row SUV, the Alcazar this month. The Creta-based seven-seater now starts at an ex-showroom price of Rs. 16.77 lakh. It can be had in seven variants, namely, Prestige, Prestige (O), Platinum, Platinum (O), ', 'New ex-showroom prices start at Rs. 16.77 lakh', 0, '2023-12-31 23:00:00', 32, 33, NULL, NULL),
(2, 'myTitle', 'mySubTitle', 'Here is a decription', 0, '2022-10-10 23:00:00', 33, NULL, NULL, NULL),
(3, 'Hyundai Verna gets a nominal price hike of Rs. 3,900', 'On the equipment front, this Honda City-rival gets a 10.25-inch touchscreen infotainment screen with wireless mobile connectivity, fully digital driver’s display, ambient lighting, wireless charger, e', 'Prices in India start from Rs. 11 lakh (ex-showroom) ', 0, '1999-12-11 23:00:00', 34, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `status` enum('bloque','confirme','attente') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'attente',
...
(1, 'Mekki', 'Soumeya', 'email1@gmail.com', 'feminin', '0000-00-00', 'attente', '12345678'),
(2, 'Mekki', 'Mohamed', 'email2@gmail.com', 'masculin', '0000-00-00', 'attente', 'abc123'),
(3, 'Mekki', 'Ali', 'email3@gmail.com', 'masculin', '0000-00-00', 'confirme', '123abc');
...
(7, 'Focus ST 2.3 EcoBoost', 'voiture', 3, 2021, 1, 1, 16, NULL),
...
(91, 'MyV', 'voiture', 5, 2024, 1, 0, 28, NULL),
